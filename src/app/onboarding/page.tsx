...
import { ArrowLeft, ArrowRight, Check, Loader2, BookOpen, DollarSign, Target, Globe, Calendar, Briefcase, Award, Monitor, Star, User, Phone, Mail } from 'lucide-react';
...
const phoneSchema = z.object({ phoneNumber: z.string().min(10, "Please enter a valid phone number.") });
const contactMethodSchema = z.object({ contactMethod: z.enum(["Email", "Phone"], { required_error: "Please select a contact method."}) });
...
const steps = [
  ...
  { id: 1, title: 'Phone Number', schema: phoneSchema, icon: Phone, fields: ['phoneNumber'] as FieldPath<FieldValues>[] },
  { id: 2, title: 'Contact Method', schema: contactMethodSchema, icon: Mail, fields: ['contactMethod'] as FieldPath<FieldValues>[] },
  { id: 3, title: 'Current Education', schema: currentEducationSchema, icon: BookOpen, fields: ['currentEducation'] as FieldPath<FieldValues>[] },
  { id: 4, title: 'Target Degree', schema: targetDegreeSchema, icon: Target, fields: ['targetDegree'] as FieldPath<FieldValues>[] },
  { id: 5, title: 'Field of Interest', schema: fieldInterestSchema, icon: Briefcase, fields: ['fieldInterest'] as FieldPath<FieldValues>[] },
  { id: 6, title: 'Annual Budget', schema: budgetSchema, icon: DollarSign, fields: ['budgetRangeUSD'] as FieldPath<FieldValues>[] },
  { id: 7, title: 'Language Preference', schema: languageSchema, icon: Globe, fields: ['englishOnly'] as FieldPath<FieldValues>[] },
  { id: 8, title: 'Preferred Region', schema: regionSchema, icon: Globe, fields: ['regionPreference'] as FieldPath<FieldValues>[] },
  { id: 9, title: 'Start Date', schema: startDateSchema, icon: Calendar, fields: ['desiredStartDate'] as FieldPath<FieldValues>[] },
  { id: 10, title: 'Career Goals', schema: careerGoalSchema, icon: Briefcase, fields: ['careerGoal'] as FieldPath<FieldValues>[] },
  { id: 11, title: 'Scholarships', schema: scholarshipSchema, icon: Award, fields: ['scholarshipInterest'] as FieldPath<FieldValues>[] },
  { id: 12, title: 'Study Mode', schema: studyModeSchema, icon: Monitor, fields: ['studyMode'] as FieldPath<FieldValues>[] },
  { id: 13, title: 'Your Priorities', schema: prioritiesSchema, icon: Star, fields: ['priorityFactors'] as FieldPath<FieldValues>[] },
];
                  ...
                  >
                    ...
                    {currentStep === 2 && (
                      <FormField control={form.control} name="contactMethod" render={({ field }) => (
                         <FormItem>
                            <FormLabel>How should we reach out to you?</FormLabel>
